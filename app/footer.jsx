...
export default function Footer() {
    return (
        <footer className='h-full pt-0 bg-white border-t-2 border-gray-200 lg:mb-5 lg:mt-20'>
            <div className='px-6 mx-auto overflow-hidden max-w-7xl sm:py-24 lg:pb-0 lg:-mt-8 lg:px-8'>
                ...
                <p className='mt-10 text-xs leading-5 text-center text-gray-500'>&copy; 2020 Your Company, Inc. All rights reserved.</p>
            </div>
        </footer>
    )
}
